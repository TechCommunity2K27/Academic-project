  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 z-[999] bg-black/90 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur-md">
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed inset-0 z-[1000] bg-black/95 backdrop-blur-md flex flex-col items-center text-xl gap-10 md:hidden transition-transform duration-300 pt-24 ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"
            }`}
        >
          {NAV_ITEMS.map((item) => (
            <a
